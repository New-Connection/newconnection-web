...
const CreateDAO: NextPage = () => {
    ...
    const [createData, setCreateData] = useState<ICreateDAOElements | null>(null);

    const handleChange: ChangeEventHandler = <T extends HTMLInputElement | HTMLTextAreaElement>(
        event: ChangeEvent<T>
    ) => {
                ...
                <section className="relative w-full">
                    <form className="mx-auto flex flex-col max-w-2xl gap-4" onSubmit={onSubmit}>
                        ...
                        <div className="flex flex-row">
                            <h2 className={"my-2 font-medium"}>DAO Name and Goals</h2>
                        </div>
                        <div className="flex flex-row">
                            <DragAndDropImage
                                label="Profile Image"
