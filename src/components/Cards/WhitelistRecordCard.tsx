...
export const WhitelistRecordCard = ({ record, isLoaded, handleWhitelistRecord }: IWhitelistRecordCard) => {
    ...
    return (
        <div className="grid grid-cols-7 items-center px-4 py-2 bg-base-300 rounded-2xl">
            ...
            {isLoaded && (
                <div className={"col-span-2 btn-group justify-self-end"}>
                    <button
                        className="btn btn-sm bg-success border-base-300"
                        onClick={async () => {
                            setClick(true);
                    ...
                    <button
                        className="btn btn-sm bg-error border-base-300"
                        onClick={async () => {
