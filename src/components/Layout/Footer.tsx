            ...
            <div className="max-w-screen-xl pb-6 px-4 mx-auto sm:px-6 lg:px-8">
                <div className="sm:flex sm:items-center sm:justify-between sm:space-y-2">
                    ...
                    <div className="flex justify-center sm:justify-start space-x-2 mt-4">
                        <button
                            className="flex pl-[0.6em] items-center cursor-not-allowed w-[60px] h-[60px] bg-gray rounded-md fill-purple hover:fill-gray2">
                            <DiscordIcon />
                        </button>
                        <a
                        ...
                        >
                            <button
                                className="w-[60px] h-[60px] pl-[0.6em] bg-gray rounded-md fill-[#1DA1F2] hover:bg-purple hover:fill-white">
                                <TwitterIcon />
                            </button>
                        </a>
                    </div>
