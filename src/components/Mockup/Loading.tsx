                ...
                <div className={"info flex flex-col ml-6 w-full gap-8"}>
                    <div className={"info-row-1 flex justify-between items-center"}>
                        ...
                        <div className={"member-button"}>
                            <button
                                className={
                                    "secondary-button disabled:bg-base-200 disabled:hover:bg-base-200 animate-pulse text-base-content/50"
                                }
                                disabled={true}
                            >
                                Become a member
            ...
            <div className="flex flex-1 flex-col justify-between bg-base-100 px-6 pt-2 pb-6">
                <div className="flex-1">
                    <div className="mt-1 flex justify-between">
                        <p className="text-base font-medium animation-pulse bg-base-200 text-base-content/50 mt-1">Nft membership</p>
                        {/* TODO: Pass variable how many minted NFT and how many left */}
                        <p className="text-base font-medium ml-4 mt-2 animate-pulse bg-base-200 text-base-content/50">499/500</p>
                    </div>
                </div>
                <div className="mt-[0.75rem] flex items-center justify-between">
                    <div className="flex-shrink-0">
                        <p className="text-sm font-normal animate-pulse bg-base-200 text-base-content/50">0x0000...0000</p>
                    </div>
